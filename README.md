...
从图片生成图纸，再按自己的想法继续精修。在同一工作台完成参数调整、图纸预览、像素级编辑、跟拼与导出。
...
看看大家分享的图纸，找到下一张想拼的作品。支持搜索标题或标签、切换「最新 / 精选 / 互动」视图，以及按更多条件筛选。

作品卡片展示图纸预览、作者、尺寸、用色色带、标签与互动统计；登录后可进一步查看色号、参与互动，或引用作品创建自己的私人设计。
