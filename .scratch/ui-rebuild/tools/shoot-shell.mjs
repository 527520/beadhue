...
const STATES = [
  ...
  { name: 'login', proto: '#/', impl: '/', guest: true, widths: ALL, proto_actions: [['click', 'header [data-login], .m-topbar [data-login]']], impl_actions: [['click', '[data-login]']] },
  { name: 'login-errors', proto: '#/', impl: '/', guest: true, widths: [1440, 390], proto_actions: [['click', 'header [data-login], .m-topbar [data-login]'], ['click', '[data-login-form] button[type="submit"]']], impl_actions: [['click', '[data-login]'], ['click', '[data-login-form] button[type="submit"]']] },
  { name: 'login-sheet', proto: '#/', impl: '/me/likes', guest: true, widths: MOBILE, proto_actions: [['click', 'header [data-login]']], impl_actions: [['click', 'main button:has-text("登录")']] },
