...
/** 我的公开作品（旧界面内容，/me/public 过渡期使用；票 06 重做）。 */
export default async function CommunityMineView() {
  const actor = await getSessionActor();
  if (!actor) redirect('/login?next=/me/public');
  ...
  return <LegacyScope><div className="workspace-page"><LegacyPageHeading title={t.title} subtitle={t.progressSubtitle} actions={<ButtonLink variant="primary" size="sm" icon="send" href="/community/submit">{t.chooseForSubmission}</ButtonLink>} /><div className="workspace-content community-page">
